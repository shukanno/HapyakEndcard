...
(function () {
    var didSetup = false,
        ...
        init = function mainSetup (isEditMode, data) {
            ...
            function getFormData(imgNum){
                document.getElementById('image'+imgNum).addEventListener('click', function(){
                    ...
                    if (data !== undefined) {
                        ...
                        input.setAttribute('value',videoId[imgNum]);
                        console.log(input);
            ...
            //         var input = document.createElement('input');
            //         input.setAttribute('type', 'hidden');
            //         input.setAttribute('videoId', 'name'); 
            //         input.setAttribute(videoId[btnNum], data);
            //         form.appendChild(input);
            //     }
            //     form.submit();
            // }
